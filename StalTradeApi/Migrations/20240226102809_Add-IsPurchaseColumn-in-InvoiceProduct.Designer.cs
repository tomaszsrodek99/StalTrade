...
namespace StalTradeAPI.Migrations
{
    ...
    [Migration("20240226102809_Add-IsPurchaseColumn-in-InvoiceProduct")]
    partial class AddIsPurchaseColumninInvoiceProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StalTradeAPI.Models.InvoiceProduct", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InvoiceProductId"), 1L, 1);
            ...
            modelBuilder.Entity("StalTradeAPI.Models.StockStatus", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StockStatusId"), 1L, 1);
                    ...
                    b.Property<decimal>("PurchasedValue")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("StalTradeAPI.Models.InvoiceProduct", b =>
                {
                    b.HasOne("StalTradeAPI.Models.Invoice", "Invoice")
            ...
            modelBuilder.Entity("StalTradeAPI.Models.StockStatus", b =>
                {
                    b.HasOne("StalTradeAPI.Models.Product", "Product")
                        .WithOne("StockStatus")
                        .HasForeignKey("StalTradeAPI.Models.StockStatus", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
