...
namespace StalTradeAPI.Dtos
{
    public class CompanyDto
    {
        ...
        [Display(Name = "Nazwa firmy"), RegularExpression(@"^[A-ZĄĆĘŁŃÓŚŹŻa-ząćęłńóśźż0-9 ]*$", ErrorMessage = "Pole musi zaczynać się od dużej litery oraz zawierać tylko litery."),
        ...
        [Display(Name = "Skrót"), RegularExpression(@"^[A-ZĄĆĘŁŃÓŚŹŻa-ząćęłńóśźż0-9 ]*$", ErrorMessage = "Pole musi zaczynać się od dużej litery oraz zawierać tylko litery."),
         Required(ErrorMessage = "Pole jest wymagane."), MaxLength(64, ErrorMessage = "Maksymalna długość to 64 litery."),
         MinLength(2, ErrorMessage = "Minimalna długość to 2 litery.")]
        ...
        [Display(Name = "Adres"), Required(ErrorMessage = "Pole jest wymagane."), MaxLength(64, ErrorMessage = "Maksymalna długość to 64 litery."),
         MinLength(4, ErrorMessage = "Minimalna długość to 4 litery."), RegularExpression(@"^[A-ZĄĆĘŁŃÓŚŹŻa-ząćęłńóśźż0-9 ]*$")]
        public string Address { get; set; } = string.Empty;
        [Display(Name = "Miasto"), RegularExpression(@"^[A-ZĄĆĘŁŃÓŚŹŻa-ząćęłńóśźż0-9 ]*$", ErrorMessage = "Pole musi zaczynać się od dużej litery oraz zawierać tylko litery."),
         Required(ErrorMessage = "Pole jest wymagane."), MaxLength(64, ErrorMessage = "Maksymalna długość to 64 litery."),
         MinLength(2, ErrorMessage = "Minimalna długość to 2 litery.")]
        ...
        [Display(Name = "Poczta"), RegularExpression(@"^[A-ZĄĆĘŁŃÓŚŹŻa-ząćęłńóśźż0-9 ]*$", ErrorMessage = "Pole musi zaczynać się od dużej litery oraz zawierać tylko litery."),
         Required(ErrorMessage = "Pole jest wymagane."), MaxLength(64, ErrorMessage = "Maksymalna długość to 64 litery."),
         MinLength(2, ErrorMessage = "Minimalna długość to 2 litery.")]
